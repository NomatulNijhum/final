...
<!-- /Menu -->
	...
	@if(Auth::user() && Auth::user()->role_id == 1|| Auth::user()->role_id == 4|| Auth::user()->role_id == 3|| Auth::user()->role_id == 2|| Auth::user()->role_id == 5 )
	...
	@if(Auth::user() && Auth::user()->role_id == 1|| Auth::user()->role_id == 4|| Auth::user()->role_id == 2 )
        <div class="widget-right">
...
@if(Auth::user() && Auth::user()->role_id == 1)
        <div class="col-md-4">
          <div class="widget-area proclinic-box-shadow color-yellow">
            ...
            <div class="widget-right">
              <h4 class="wiget-title">Total Price </h4>
              <span class="numeric color-yellow">{{$totals}}</span>
        ...
        <div class="col-md-4">
          <div class="widget-area proclinic-box-shadow color-yellow">
            ...
            <div class="widget-right">
              ...
              <span class="numeric color-yellow">{{$medicines->count()}}</span>
              <p class="inc-dec mb-0"><span class="ti-angle-up"></span> </p>
            </div>
          </div>
        </div>
