...
<!-- /Menu -->
    ...
    <form id="birthreport_update" action="{{route ('birthreport_update')}}" method="post" enctype="multipart/form-data">
              @csrf
      <input type="hidden" name="birth_id" value="{{ $single_birthreport->id }}">
